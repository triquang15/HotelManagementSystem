...
public class EmployeesScreenController implements Initializable {
    ...
    void search(MouseEvent event) {
		...
		ResultSet resultSet = preparedStatement.executeQuery();
                if (resultSet.next()) {
                    ...
                    fullName.setText(resultSet.getString(4));
                    address.setText(resultSet.getString(7));
                    phone.setText(resultSet.getString(5));
                    salary.setText(resultSet.getString(6));
                    userType.setText(resultSet.getString(9));
                }
    ...
    private void loadAllUsers(String sql) {
        ...
        JFXTreeTableColumn<Employee, String> emp_address = new JFXTreeTableColumn<>("Phone");
        ...
        JFXTreeTableColumn<Employee, String> emp_phone = new JFXTreeTableColumn<>("Salary");
        ...
        JFXTreeTableColumn<Employee, String> emp_startdate = new JFXTreeTableColumn<>("Role");
        ...
        JFXTreeTableColumn<Employee, String> emp_salary = new JFXTreeTableColumn<>("Address");
        ...
        JFXTreeTableColumn<Employee, String> emp_usertype = new JFXTreeTableColumn<>("Start Date");
